...
class PronounceLevel1Activity : AppCompatActivity() {
    private lateinit var translator: Translator
    private lateinit var correctPhrase: String
    private lateinit var spanishWord: String
    private val allWords = listOf("rojo", "verde", "azul", "negro", "amarillo", "blanco")
    ...
    private fun startRecording(){
        ...
        audioFile=File(cacheDir,"pronounce1.m4a")
        ...
        client.newCall(req).enqueue(object:Callback{
            ...
            override fun onResponse(c:Call,r:Response){
                ...
                runOnUiThread{
                    ...
                    saveProgress("pronounce1",correct)
                    if(correct){
                        Handler(Looper.getMainLooper()).postDelayed({
                            val intent = Intent(this@PronounceLevel1Activity, MainMenuActivity::class.java).apply {
