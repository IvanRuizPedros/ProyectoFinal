...
class PronounceLevel3Activity : AppCompatActivity() {
    private lateinit var translator: Translator
    private lateinit var correctPhrase: String
    private lateinit var spanishWord: String
    private val allWords = listOf("correr", "cantar", "dormir", "escribir", "leer", "nadar")
    ...
    private fun startRecording(){
        ...
        audioFile=File(cacheDir,"pronounce3.m4a")
        ...
        client.newCall(req).enqueue(object:Callback{
            ...
            override fun onResponse(c:Call,r:Response){
                ...
                runOnUiThread{
                    ...
                    saveProgress("pronounce3",correct)
                    if(correct){
                        Handler(Looper.getMainLooper()).postDelayed({
                            val intent = Intent(this@PronounceLevel3Activity, MainMenuActivity::class.java).apply {
